...
<head>
    <title>Open Unifeob - Editar vídeo</title>
    <meta charset="utf-8">
    ...
    <div class="container col-lg-6 col-xl-5 mt-5">
        <form action="../models/updateVideoModel.php?id=<?php echo $_GET["id"]?>" method="post" class="shadow">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="titulo" name="titulo" placeholder="Digite aqui o título do vídeo" required value="<?php echo $titulo ?>">
            </div>
            <div class="form-group">
                <label for="link">Link do Youtube:</label>
                <input type="text" class="form-control" id="link" name="link" placeholder="Cole aqui o link do vídeo do Youtube" required value="https://www.youtube.com/watch?v=<?php echo $link?>">
            </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="descricao" name="descricao" rows="8" maxlength="500" placeholder="Digite aqui a descrição do vídeo (limite de 500 caracteres)" required><?php echo ($descricao)?></textarea>
            </div>
