    ...
    <form class="container col-lg-6 col-xl-5 mt-4" action="../models/minhaContaUpdateModel.php?id=<?php echo $id_user ?>" method="post">
        <div class="form-row">
            ...
            <div class="col-md-7 mb-3">
                ...
                <input type="text" class="form-control" id="sobrenome" name="sobrenome" placeholder="Digite seu sobrenome" value="<?php echo $sobrenome ?>" required>
            </div>
        </div>
        <div class="form-row">
            ...
            <div class="col-md-6 mb-3">
                ...
                <div class="d-flex">
                    <input type="text" class="form-control" id="ddd" name="ddd" maxlength="2" placeholder="DDD" style="width:60px" value="<?php echo $ddd ?>">
                    <input type="text" class="form-control" id="telefone" name="phone" placeholder="Telefone" value="<?php echo $telefone ?>">
                </div>
            </div>
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" id="status" name="perfil" rows="8" maxlength="500" placeholder="Conte aqui um pouco do seu perfil"><?php echo $perfil ?></textarea>
        </div>
